...
export default function Auth({ onAuthSuccess, existingLocalData, initialMode = 'login' }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-red-500 to-yellow-500 flex flex-col items-center justify-center p-4">
      ...
      <p className="mt-4 text-center text-white/40 text-xs">By using HolaCatal� you agree to our <a href="/privacy-policy.html" target="_blank" className="underline hover:text-white/70">Privacy Policy</a></p>
      </div>
    </div>
  );
}
