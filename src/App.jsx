...
import { CheckCircle, Lock, Award, Home, User, ArrowRight, RotateCw, BookOpen, Calendar, TrendingUp, MessageCircle, Clock, X, Trophy, Star } from 'lucide-react';
            ...
            {isUserTurn && (
              <>
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {currentTurn.wordBank.map((word, i) => <button key={i} onClick={() => addWordToSentence(word)} className="bg-gray-100 hover:bg-gray-200 px-4 py-2 rounded-lg font-semibold transition-all">{word}</button>)}
                </div>
